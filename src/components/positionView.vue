            ...
            >
              <table class="table table-striped">
                ...
                <tbody style="font-size: 16px">
                  <tr
                    v-if="positionEmployees.length && !isPositionLoading"
                    v-for="(employer, index) in positionEmployees"
                  >
                    <td>{{ index + 1 }}</td>
                    <td>{{ employer.id }}</td>
                  ...
                  <tr
                    v-if="positionEmployees.length === 0 && !isPositionLoading"
                  >
                    <td colspan="3" style="text-align: center">
                      No employers found.
                    </td>
                  </tr>
                  <tr v-if="isPositionLoading">
